...
TextStyle blackFontStyle3 = GoogleFonts.poppins().copyWith(color: Colors.black, fontWeight: FontWeight.w500);
TextStyle greenFontStyle3 = GoogleFonts.poppins().copyWith(color: greenColor, fontWeight: FontWeight.w500);
TextStyle secondColorFontStyle = GoogleFonts.poppins().copyWith(color: secondColor, fontWeight: FontWeight.w500);
